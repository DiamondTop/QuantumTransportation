...
.qt-logo-text span { color: #C9A84C; }
...
.qt-nav-links a:hover { color: #C9A84C; }
.qt-nav-cta {
...
.stat-n {
    font-family: 'Syne', sans-serif;
    font-size: 2.2rem; font-weight: 800; color: #C9A84C;
...
/* ═══════════ TICKER STRIP ═══════════ */
.ticker-wrap {
    background: linear-gradient(90deg, #C9A84C 0%, #A07830 100%);
...
.rate-badge-icon { color: #C9A84C; font-size: 1rem; }
.rate-badge-text {
    font-family: 'Space Grotesk', sans-serif;
...
.avc-num {
    font-family: 'Syne', sans-serif;
    font-size: 2.8rem; font-weight: 800; color: #C9A84C;
...
.pill-dot { width: 6px; height: 6px; background: #C9A84C; border-radius: 50%; }
...
.contact-val a:hover { color: #C9A84C; }
.form-label {
    display: block;
    font-family: 'Space Grotesk', sans-serif;
...
.footer-sep { color: #C9A84C; margin: 0 8px; }
.gradient-line {
    width: 100%; height: 2px;
    background: linear-gradient(90deg, transparent, #C9A84C 30%, #A07830 70%, transparent);
...
<div class="contact-wrap">
  <div class="contact-left">
    ...
    <div class="contact-item">
      <div class="contact-icon" style="font-size:0.75rem;font-weight:700;font-family:'Space Grotesk',sans-serif;color:#C9A84C;letter-spacing:0.04em;">LOC</div>
      <div>
    ...
    <div class="contact-item">
      <div class="contact-icon" style="font-size:0.75rem;font-weight:700;font-family:'Space Grotesk',sans-serif;color:#C9A84C;letter-spacing:0.04em;">TEL</div>
      <div>
    ...
    <div class="contact-item">
      <div class="contact-icon" style="font-size:0.75rem;font-weight:700;font-family:'Space Grotesk',sans-serif;color:#C9A84C;letter-spacing:0.04em;">24H</div>
      <div>
    ...
    <div class="contact-item">
      <div class="contact-icon" style="font-size:0.75rem;font-weight:700;font-family:'Space Grotesk',sans-serif;color:#C9A84C;letter-spacing:0.04em;">ETA</div>
      <div>
        <div class="contact-lbl">Quote Response Time</div>
        <div class="contact-val">Within 1 hour during business hours</div>
      </div>
    </div>
    <div style="margin-top: 40px; padding: 24px; background: rgba(201,168,76,0.05); border: 1px solid rgba(201,168,76,0.15); border-radius: 10px;">
