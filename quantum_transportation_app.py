...
.qt-logo-text span { color: #FF8C00; }
...
.qt-nav-links a:hover { color: #FF8C00; }
.qt-nav-cta {
...
.hero-glow-2 {
    ...
    background: radial-gradient(circle, rgba(224,120,0,0.05) 0%, transparent 70%);
    pointer-events: none;
}
.hero-grid-lines {
    position: absolute; inset: 0;
...
.btn-ghost:hover {
    border-color: #FF8C00; color: #FF8C00 !important;
...
.stat-n {
    font-family: 'Syne', sans-serif;
    font-size: 2.2rem; font-weight: 800; color: #FF8C00;
...
/* ═══════════ TICKER STRIP ═══════════ */
.ticker-wrap {
    background: linear-gradient(90deg, #FF8C00 0%, #E07800 100%);
...
.rate-badge-icon { color: #FF8C00; font-size: 1rem; }
.rate-badge-text {
    font-family: 'Space Grotesk', sans-serif;
...
.avc-num {
    font-family: 'Syne', sans-serif;
    font-size: 2.8rem; font-weight: 800; color: #FF8C00;
...
.pill-dot { width: 6px; height: 6px; background: #FF8C00; border-radius: 50%; }
...
.wq-card::after {
    ...
    height: 2px;
    background: linear-gradient(90deg, #FF8C00, #E07800);
...
.form-input:focus, .form-select:focus, .form-textarea:focus {
    ...
    box-shadow: 0 0 0 3px rgba(255,140,0,0.06);
}
...
.footer-head {
    ...
    text-transform: uppercase; color: #FF8C00; margin-bottom: 20px;
}
...
.footer-sep { color: #FF8C00; margin: 0 8px; }
.gradient-line {
    width: 100%; height: 2px;
    background: linear-gradient(90deg, transparent, #FF8C00 30%, #E07800 70%, transparent);
...
<div class="about-wrap">
  <div class="about-visual">
    <img src="https://images.unsplash.com/photo-1616432043562-3671ea2e5242?w=900&q=85&auto=format&fit=crop&crop=center" alt="Truck driver cab interior POV" />
...
<div class="contact-wrap">
  <div class="contact-left">
    ...
    <div class="contact-item">
      <div class="contact-icon" style="font-size:0.75rem;font-weight:700;font-family:'Space Grotesk',sans-serif;color:#FF8C00;letter-spacing:0.04em;">LOC</div>
      <div>
    ...
    <div class="contact-item">
      <div class="contact-icon" style="font-size:0.75rem;font-weight:700;font-family:'Space Grotesk',sans-serif;color:#FF8C00;letter-spacing:0.04em;">TEL</div>
      <div>
    ...
    <div class="contact-item">
      <div class="contact-icon" style="font-size:0.75rem;font-weight:700;font-family:'Space Grotesk',sans-serif;color:#FF8C00;letter-spacing:0.04em;">24H</div>
      <div>
    ...
    <div class="contact-item">
      <div class="contact-icon" style="font-size:0.75rem;font-weight:700;font-family:'Space Grotesk',sans-serif;color:#FF8C00;letter-spacing:0.04em;">ETA</div>
      <div>
        <div class="contact-lbl">Quote Response Time</div>
        <div class="contact-val">Within 1 hour during business hours</div>
      </div>
    </div>
    <div style="margin-top: 40px; padding: 24px; background: rgba(255,140,0,0.05); border: 1px solid rgba(255,140,0,0.15); border-radius: 10px;">
      <div style="font-family:'Space Grotesk',sans-serif; font-size:1rem; font-weight:700; color:#fff; margin-bottom:8px; letter-spacing:0.02em;">Storage Inquiries</div>
