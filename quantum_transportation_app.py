...
.hero-sub {
    ...
    color: #7a9bb5; max-width: 500px; margin-bottom: 44px;
}
...
.stat-l {
    ...
    color: #4a6880; letter-spacing: 0.06em;
...
.section-sub {
    font-size: 1rem; font-weight: 300; color: #5a7a94;
...
.svc-card.featured img { min-height: 480px; }
...
.svc-desc {
    font-size: 0.86rem; font-weight: 300; color: #5a7a94;
    line-height: 1.6;
...
.rates-body {
    font-size: 0.95rem; font-weight: 300; color: #5a7a94;
...
.avc-label {
    font-size: 0.82rem; font-weight: 300; color: #5a7a94;
...
.about-copy p {
    font-size: 0.97rem; font-weight: 300; color: #5a7a94;
...
.port-detail {
    font-size: 0.84rem; font-weight: 300; color: #405868;
    line-height: 1.5;
}
...
.sf-icon {
    font-size: 1.3rem; line-height: 1; margin-top: 2px; flex-shrink: 0;
}
.sf-title {
    font-family: 'Space Grotesk', sans-serif;
...
.sf-detail {
    font-size: 0.82rem; font-weight: 300; color: #3d5a6e; line-height: 1.5;
}
.storage-visual {
    position: relative; overflow: hidden;
}
...
.wq-body {
    font-size: 0.88rem; font-weight: 300; color: #3d5a6e; line-height: 1.75;
}
...
.form-label {
    ...
    text-transform: uppercase; color: #3d5a6e;
    margin-bottom: 8px;
}
...
.footer-tagline {
    font-size: 0.88rem; font-weight: 300; color: #2d4460;
...
.footer-links li a {
    font-size: 0.88rem; color: #2d4460; text-decoration: none;
...
.footer-copy { font-size: 0.78rem; color: #1a2d40; }
...
ticker_items = [
    ...
    "Rail Ramp Access", "TWIC Compliant", "Bonded & Insured",
...
<div class="section section-dark">
  <div class="services-header">
    <div>
      ...
      <div class="section-title">End-to-End<br>Freight Solutions</div>
    </div>
  ...
  <div class="services-flex">
    ...
    <div class="svc-card">
      <img src="https://images.unsplash.com/photo-1519003300449-424ad0405076?w=800&q=80&auto=format&fit=crop" alt="Rail Intermodal" />
      <div class="svc-overlay">
        <div class="svc-tag">Intermodal</div>
        <div class="svc-name">Rail Ramp Service</div>
        <div class="svc-desc">BNSF San Bernardino and UP City of Industry rail ramp pickups and deliveries on schedule.</div>
        <div class="svc-arrow">→</div>
      </div>
    </div>
    <div class="svc-card">
...
<div class="storage-section">
  <div class="storage-copy">
    ...
    <div class="section-title">Secure Storage<br>Near the Port</div>
    <p>
...
<div class="ports-section">
  ...
  <div class="section-title">California's Busiest<br>Port Gateways</div>
  ...
  <div class="ports-grid">
    <div class="port-card">
      <div class="port-card-img">
        <img src="https://images.unsplash.com/photo-1494412651409-8963ce7935a7?w=800&q=80&auto=format&fit=crop" alt="Port of Los Angeles" />
      </div>
    ...
    <div class="port-card">
      <div class="port-card-img">
        <img src="https://images.unsplash.com/photo-1519003300449-424ad0405076?w=800&q=80&auto=format&fit=crop" alt="Rail Ramps" />
      </div>
      <div class="port-card-body">
        <div class="port-badge">Intermodal Rail</div>
        <div class="port-name">Rail Ramps — SoCal</div>
        <div class="port-detail">BNSF San Bernardino &amp; UP City of Industry — daily dispatch capability</div>
      </div>
    </div>
  </div>
</div>
...
<div class="about-wrap">
  <div class="about-visual">
    <img src="https://images.unsplash.com/photo-1568027762272-e4da8b386fe9?w=900&q=85&auto=format&fit=crop" alt="Container operations" />
  ...
  <div class="about-copy">
    ...
    <div class="section-title">Built on Reliability.<br>Driven by Value.</div>
    <p>
...
<div class="contact-wrap">
  <div class="contact-left">
    ...
    <div class="section-title" style="margin-bottom: 44px;">Ready to Move<br>Smarter?</div>
    ...
    <div style="margin-top: 40px; padding: 24px; background: rgba(0,210,190,0.05); border: 1px solid rgba(0,210,190,0.15); border-radius: 10px;">
      ...
      <div style="font-size:0.88rem; font-weight:300; color:#3d5a6e; line-height:1.7;">Mention container storage in your message and our team will provide availability and rate information same day.</div>
    </div>
  </div>
  <div class="contact-right">
    <div class="section-label">Request a Rate</div>
    <div class="section-title" style="margin-bottom:36px;">Tell Us About<br>Your Freight</div>
    <div class="form-row">
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <select class="form-select">
          ...
          <option>Rail Ramp Pickup/Delivery</option>
  ...
  <div class="footer-grid">
    ...
    <div>
      ...
      <ul class="footer-links">
        ...
        <li><a href="#">Rail Ramp Intermodal</a></li>
